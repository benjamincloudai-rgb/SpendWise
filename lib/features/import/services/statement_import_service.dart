...
/// delegated to [CsvStatementParser] or [XlsxStatementParser] depending on the
/// file type, classification to [StatementClassifier], and the UI only ever
/// sees a [StatementImportResult].
